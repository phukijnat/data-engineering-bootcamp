...
KEYFILE_FOR_GCS = "deb-uploading-files-to-gcs"
KEYFILE_FOR_GCS_TO_BIGQUERY = "deb-loading-data-to-bq"


def _load_data_from_gcs_to_bigquery(data_interval_start, **context):
    ds = data_interval_start.to_date_string()

    keyfile_bigquery = f"{DAGS_FOLDER}/{KEYFILE_FOR_GCS_TO_BIGQUERY}.json"
    ...
    table_id = f"{GCP_PROJECT_ID}.networkrail.movements"
